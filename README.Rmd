...
Nevertheless, you can filter the data by specifying the level of significance (`pval`) and the column to apply it (`pval.column`). In the following chunk, we will restrict our representation to mediation analyses with an adjusted p-value <= 0.05.
```{r visualizing-3}
