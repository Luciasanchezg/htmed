...
We need to transform this data to simplify it and make it more user-friendly for the visualizations that will be performed later. Using `formatting_med()` with just `med_results` as input, we will generate a dataframe with the essential columns needed for the visualizations. 
